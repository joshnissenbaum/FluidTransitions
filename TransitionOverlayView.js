...
class TransitionOverlayView extends React.Component<Props> {
  ...
  render() {
    ...
    transitionElements = transitionElements
      ? transitionElements.filter(i => !i.inline && (i.route === from || i.route === to))
      : [];

    sharedElements = sharedElements
      ? sharedElements.filter(
          p =>
  ...
  getTransitionContext(transitionElements): TransitionContext {
    const { getDirectionForRoute, getIndex, getDirection, getRoutes, getTransitionProgress } = this.context;
